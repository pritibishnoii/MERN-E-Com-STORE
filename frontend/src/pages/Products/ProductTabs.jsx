    ...
    <div className="flex flex-col md:flex-row">
              ...
              <form onSubmit={submitHandler}>
                <div className="my-2">
                  ...
                  <select
                    ...
                    className="p-2 border rounded-lg xl:w-[40rem] text-pink-500 outline-none"
                  >
      ...
      <section>
        {activeTab === 2 && (
          <>
            <div>
              {products?.product.reviews.length === 0 && <p>No Reviews</p>}
            </div>
                ...
                >
                  <div className="flex justify-between">
                    ...
                    <p className="text-[#B0B0B0]">
                      {review.createdAt?.substring(0, 10) || "N/A"}
                    </p>
                  </div>
